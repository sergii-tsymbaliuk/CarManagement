...
//		generateSomeMoreCars();
		...
		CarDao carDao =  AC.getBean(CarDao.class);
		
				
//		System.out.println("Cars with model LAZ:");
//		for (Car c : carDao.findByModelName("LAZ"))
//			System.out.println(c);
//		
//		System.out.println("Cars with power between 50 and 180:");		
//		for (Car c : carDao.findByPowerBetween(50, 180))
//			System.out.println(c);;
		
		Car car = new Car( new CarModel("Spark",new Date()),
						new Engine121("ZZVS", 300, 3000, 6) );
